...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let T1_Ans2 = answer2a
        
        storyTextView.text = T1_Story
        topButton.setTitle(T1_Ans1, for: UIControlState.normal)
        bottomButton.setTitle(T1_Ans2, for: UIControlState.normal)
    ...
    @IBAction func buttonPressed(_ sender: UIButton) {
        ...
        //force story index number based on user choice
